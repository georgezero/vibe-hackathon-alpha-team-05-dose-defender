# Prompt Strategy — Dose Defenders

Key prompts and prompt patterns used during development with Claude Code, Codex CLI.

## Bootstrap prompt

```
I'm building a browser-based HTML5 canvas game called "Dose Defender".
